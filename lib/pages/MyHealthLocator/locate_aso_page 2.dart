...
class _LocateASOPageState extends State<LocateASOPage> {
  ...
  Future<void> _launchURL(String url) async {
    ...
    print("Parsed URL: $uri"); // Debug print for the parsed URL
    if (await canLaunchUrl(uri)) {
      print("Can launch URL: $uri"); // Debug print if the URL can be launched
      await launchUrl(uri, mode: LaunchMode.externalApplication);
      print(
          "URL launched successfully: $uri"); // Debug print after the URL is launched
    } else {
      print(
          "Could not launch URL: $uri"); // Debug print if the URL can't be launched
